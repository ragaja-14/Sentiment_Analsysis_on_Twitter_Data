...
read_csv_path = 'new_tweets.csv'
write_csv_path = '../streamed_test_data/new_clean_tweets.csv'
...
# remove tweets without a valid company labels
df = df.dropna()
